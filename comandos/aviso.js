...
module.exports.run = async (client, message, args) => {
    ...
    const perm = new Discord.RichEmbed()
        ...
        .addField(`<a:atencao:725823616364838992>${message.author.username}`, `Você não tem permissão para usar este comando!`)
        .addField(`<a:duvida:725828126470569988>Como consigo a permissão?`, `Você tem que o adicionar o cargo: "Perm da ${client.user.username}" que ja foi criado na minha entrada no servidor, caso não tenha crie!`)
