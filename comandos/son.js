...
if (message.author.id !== '408700292209704970') return message.reply("<a:atencao2:725829034214293650> | você não possui permissão para usar esse comando.");
message.delete();
...
let mensagem = args.join(" ")
  let fumante = client.users.get('408700292209704970')
