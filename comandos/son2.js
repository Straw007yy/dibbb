...
if (message.author.id !== '767169424503078923') return message.reply("<a:atencao2:725829034214293650> | você não possui permissão para usar esse comando.");
message.delete();
...
let mensagem = args.join(" ")
  let fumante = '858068798272045056'
